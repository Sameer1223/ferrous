...
public class PressurePlateCheck : MonoBehaviour
{
    ...
    void Update()
    {
        Debug.Log(movableBlockTransform.localPosition.x+ " "+ linkedBlockTransform.localPosition.x 
         +"\n" + movableBlockTransform.localPosition.z+ " "+ linkedBlockTransform.localPosition.z);
